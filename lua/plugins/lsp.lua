...
return {
	{
      ...
      --[[
        ...
        lua_ls = {  -- Locate the lua_ls setup block
          cmd = {"/home/saidler/.nix-profile/bin/lua-language-server"},  -- Pointing directly to the nix installed path
          settings = {
            Lua = {
              runtime = { version = "LuaJIT" },
              workspace = {
